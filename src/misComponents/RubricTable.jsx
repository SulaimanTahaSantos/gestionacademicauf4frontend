...
export default function RubricTable({ rubrics, onEdit, onDelete, onPreview, isDeleting = false, rol }) {
    return (
          ...
          <TableBody>
            {rubrics.length === 0 ? (
              <TableRow>
                ...
                >
                  No hay rúbricas disponibles. Crea una nueva rúbrica para
                  comenzar.
                </TableCell>
              </TableRow>
            ) : (
                          ...
                          <Tooltip>
                            <TooltipTrigger>
                              <Badge variant="outline">
                                {rubric.evaluadores.length} evaluadores
                              </Badge>
                            </TooltipTrigger>
                            <TooltipContent>
                              <ul className="list-disc pl-5">
                                {rubric.evaluadores.map((evaluador, index) => (
                                  <li key={index}>{evaluador}</li>
                                ))}
                              </ul>
                            </TooltipContent>
                          </Tooltip>
